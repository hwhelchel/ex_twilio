...
defmodule TestHelper do
  ...
  def with_fixture(:get, response, fun),    do: with_fixture({:get,    fn(_url, _) -> response end}, fun)
  def with_fixture(:post, response, fun),   do: with_fixture({:post,   fn(_url, _options) -> response end}, fun)
  def with_fixture(:delete, response, fun), do: with_fixture({:delete, fn(_url, _) -> response end}, fun)
